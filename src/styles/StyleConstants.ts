...
export const FONT_SIZE_LABEL = `${FONT_SIZE_BASE * 0.75}px`; // 12px
export const FONT_SIZE_SUBTITLE = `${FONT_SIZE_BASE * 0.8125}px`; // 13px
export const FONT_SIZE_BODY = `${FONT_SIZE_BASE * 0.875}px`;  // 14px
export const FONT_SIZE_SUBHEADING = `${FONT_SIZE_BASE * 0.9375}px`; // 15px
export const FONT_SIZE_TITLE = `${FONT_SIZE_BASE}px`;  // 16px
export const FONT_SIZE_HEADING = `${FONT_SIZE_BASE * 1.125}px`;  // 18px
export const FONT_SIZE_ICON_SM = `${FONT_SIZE_BASE * 1.25}px`; // 20px
export const FONT_SIZE_ICON_MD = `${FONT_SIZE_BASE * 1.5}px`; // 24px
export const FONT_SIZE_ICON_LG = `${FONT_SIZE_BASE * 1.75}px`; // 28px
export const FONT_SIZE_ICON_XL = `${FONT_SIZE_BASE * 2}px`; // 32px
export const FONT_SIZE_ICON_XXL = `${FONT_SIZE_BASE * 2.25}px`; // 36px
...
export const LINE_HEIGHT_ICON_XL = `${FONT_SIZE_BASE * 2.5}px`; // 40px
export const LINE_HEIGHT_ICON_XXL = `${FONT_SIZE_BASE * 2.75}px`; // 44px
