...
import injectReducerEnhancer from "@/redux/enhancer";

const enhancers: any = [injectReducerEnhancer(createReducer)];
...
export const store = configureStore({
    ...
    // enhancers 是 Redux 应用中用于增强 Redux store 功能的一种机制。它可以是一个可选的数组或者一个回调函数，用于自定义 enhancers 数组。
    enhancers
})